...
public:
    ...
    Vector(Vector && v); //Move Constructor with Rvalue Rule 4 of 5 for Rule of 5 - C++ 11 and beyond
    Vector& operator=(Vector && v); //Move Assignment 5 of 5 rule for Rule of 5 - C++ 11 and beyond
